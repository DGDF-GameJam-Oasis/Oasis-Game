...
// #if UNITY_EDITOR
[CreateAssetMenu(menuName = "Scripts/Interactable Tiles/TileBehaviour")]
public class TileBehaviour : Tile
{
    ...
    // public static void CreateTileBehaviour()
    // {
    //     string path = EditorUtility.SaveFileInProject("Save Variable Tile");
    // }
// #endif
}